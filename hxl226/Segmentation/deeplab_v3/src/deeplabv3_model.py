...
def deeplabv3_mobilenetv2(aux, num_classes=21, pretrain_backbone=False):
    backbone = MobileNetV2(num_classes=257)

    if pretrain_backbone:
        backbone.load_state_dict(torch.load("Mobilenetv2_e6_c256_300_16bc_adamWlr0.002-0.00002warmup.pth",
                                            map_location='cpu'))
...
def deeplabv3_mobilenets(aux, num_classes=21, pretrain_backbone=False):
    backbone = MobileNet_s(num_classes=257)

    if pretrain_backbone:
        backbone.load_state_dict(torch.load("Mobilenets_e6ori_first_c256_300_16bc_adamWlr0.002-0.00002.pth",
                                            map_location='cpu'))
