...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16-ssd':
        ...
        create_net = lambda num: create_mobilenetv2_ssd_lite(num, width_mult=1/3.)
        config = mobilenetv1_ssd_config
    elif args.net == 'mbs-ssd-lite':
        # print(create_mobilenet_s_ssd_lite)
        create_net = lambda num: create_mobilenet_s_ssd_lite(num, width_mult=1/3.)
        config = mobilenetv1_ssd_config
