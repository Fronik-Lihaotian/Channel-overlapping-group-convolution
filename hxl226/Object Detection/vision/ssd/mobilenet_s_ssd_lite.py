...
from ..nn.model_s import MobileNet_s
...
def create_mobilenet_s_ssd_lite(num_classes, width_mult=1., is_test=False):
    base_net = MobileNet_s().features

    source_layer_indexes = [
        GraphPath(14, 'conv2', 1),
        19,
    ]
    extras = ModuleList([
...
def create_mobilenet_s_ssd_lite_predictor(net, candidate_size=200, nms_method=None, sigma=0.5, device=torch.device('cpu')):
